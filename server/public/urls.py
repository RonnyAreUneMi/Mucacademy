...
urlpatterns = [
    ...
    path('cuenta/programas/',     account_views.programas_view,    name='account_programas'),
    path('cuenta/programas/<int:program_id>/',
    ...
    path('cuenta/evaluaciones/<int:evaluation_id>/resumen/',
         account_views.evaluacion_resumen_view, name='account_evaluacion_resumen'),
